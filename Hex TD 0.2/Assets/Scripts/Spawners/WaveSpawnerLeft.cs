...
public class WaveSpawnerLeft : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (noEnemiesComing == false)
        {
            ...
            Instantiate(waveStarter, WaveIndicatorPosition.position, Quaternion.Euler(90f, -90f, 0f));
    ...
    void Update()
    {
        ...
        if (Wave.EnemiesAlive == 0 && waveIndex != waves.Length)
        {
            ...
            if (waveIndicatorPlaced == false && waveIndex > 1 && noEnemiesComing == false)
            {
                ...
                Instantiate(waveIndicator, WaveIndicatorPosition.position, Quaternion.Euler(90f, -90f, 0f));
