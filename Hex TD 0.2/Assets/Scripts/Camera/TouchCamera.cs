...
public class TouchCamera : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        if (Input.GetMouseButtonDown(0)) //(Input.touchCount == 1 && Input.GetTouch(0).phase == TouchPhase.Moved)
        {
            Vector2 touchposition = Input.mousePosition;//Input.GetTouch(0).deltaPosition;
    ...
    void ZoomCamera(float offset, float speed)
    {
        ...
        cam.fieldOfView = Mathf.Clamp(cam.fieldOfView - (offset * speed), maxDistance, minDistance);
