...
public class Poison : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (dir.magnitude <= distancePerFrame)
        {
            ...
            audioplay.PlayAudio();
            PoisonPooler.Instance.AddToPool(gameObject);
            TargetAquired = false;
            return;
     ...
     void HitTarget()
    {
        ...
        if (target != null)
        {
            ...
            effectIns = PoisonPooler.Instance.EffectGetFromPool();
        ...
        void Damage(Transform target)
        {
            ...
            healthScript.PoisonDamage(damage);
            healthScript.takeDamage(impactdamage);
    ...
    void Enqueue()
    {
        PoisonPooler.Instance.EffectAddToPool(effectIns);
    }
